...
// creating gameover sprite and overlapping gameover img over the rectangular sprite
  gameOver = createSprite(windowWidth / 2, windowHeight / 2);
  gameOver.addImage(gameOverImg);
// creating restart sprite to restart game
  restart = createSprite(windowWidth / 2, windowHeight / 2 + 40);
  restart.addImage(restartImg);
// changing scales of both gameover and restart img
  gameOver.scale = 0.5;
  restart.scale = 0.5;
...
// using if condition for gamestate === play
  if (gameState === PLAY) {
    gameOver.visible = false;
    restart.visible = false;
     // so that we can follow trex
